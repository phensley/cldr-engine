...
const mappings: Mapping[] = [
  ...
  Mappings.fields(widths).field('per')
    .field('compoundUnitPattern', 'perPattern').remap(0, 2, 3),
  Mappings.fields(widths).field('times')
    .field('compoundUnitPattern', 'timesPattern').remap(0, 2, 3),
