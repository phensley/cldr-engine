...
export const ACCELERATION: UnitFactorMapEntry[] = [
  ['g-force', ['9.80665', 'meter-per-second-squared']]
];

export const ANGLE: UnitFactorMapEntry[] = [
...
export const AREA: UnitFactorMapEntry[] = [
...
export const CONSUMPTION: UnitFactorMapEntry[] = [
  ['liter-per-100kilometers', ['1 / 100', 'liter-per-kilometer']]
];

const DIGITAL_BASE: UnitFactorMapEntry[] = [
  ...kfactors('1000', ['terabit', 'gigabit', 'megabit', 'kilobit', 'bit']),
  ['byte', ['8', 'bit']],
];

export const DIGITAL: UnitFactorMapEntry[] = [
  ...DIGITAL_BASE,
  ...kfactors('1024', ['terabyte', 'gigabyte', 'megabyte', 'kilobyte', 'byte'])
];

export const DIGITAL_DECIMAL: UnitFactorMapEntry[] = [
  ...DIGITAL_BASE,
  ...kfactors('1000', ['terabyte', 'gigabyte', 'megabyte', 'kilobyte', 'byte'])
];

export const ELECTRIC: UnitFactorMapEntry[] = [
  ['ampere', ['1000', 'milliampere']]
];

export const ENERGY: UnitFactorMapEntry[] = [
...
export const FORCE: UnitFactorMapEntry[] = [
  ['pound-force', ['4.448222', 'newton']]
];

export const FREQUENCY: UnitFactorMapEntry[] =
  kfactors('1000', ['gigahertz', 'megahertz', 'kilohertz', 'hertz']);

export const GRAPHICS_PER: UnitFactorMapEntry[] = [
  ['dot-per-inch', ['1', 'pixel-per-inch']],
  ['dot-per-centimeter', ['2.54', 'dot-per-inch']],
];

export const GRAPHICS_PIXEL: UnitFactorMapEntry[] = [
  ['megapixel', ['1000000', 'pixel']]
];

export const LENGTH: UnitFactorMapEntry[] = [
...
export const POWER: UnitFactorMapEntry[] = [
  ...kfactors('1000', ['gigawatt', 'megawatt', 'kilowatt', 'watt']),
    ['horsepower', ['745.69987158227', 'watt']]
];

export const PRESSURE: UnitFactorMapEntry[] = [
...
export const VOLUME: UnitFactorMapEntry[] = [
  ...VOLUME_BASE,
...
export const VOLUME_UK: UnitFactorMapEntry[] = [
  ...VOLUME_BASE,
