...
// @public (undocumented)
export type UnitCategory = 'acceleration' | 'angle' | 'area' | 'concentr' | 'consumption' | 'digital' | 'duration' | 'electric' | 'energy' | 'force' | 'frequency' | 'graphics' | 'length' | 'light' | 'magnetic' | 'mass' | 'power' | 'pressure' | 'speed' | 'temperature' | 'torque' | 'volume';
