...
test('basic', () => {
  ...
  expect(c).toEqual([
    ...
    [
      [MessageOpType.TEXT, 'A '],
      [MessageOpType.SELECT, [0], [['other', [MessageOpType.TEXT, '1 foobar baz']]]],
      [MessageOpType.TEXT, ' B'],
    ],
  ]);
  ...
  expect(c).toEqual([
    ...
    [
      [MessageOpType.TEXT, 'A '],
      [MessageOpType.SELECT, [0], [['foo', [MessageOpType.TEXT, '1 plural one']]]],
      [MessageOpType.TEXT, ' B'],
    ],
  ]);
...
test('escapes', () => {
  ...
  expect(c).toEqual([
    ...
    [
      [MessageOpType.TEXT, '{0 plural one '],
      [MessageOpType.SELECT, [1], [['baz', [MessageOpType.TEXT, 'hi there']]]],
      [MessageOpType.TEXT, ' }'],
    ],
  ]);
});
      ...
      [
        ...
        [
          ...
          [
            PluralChoiceType.CATEGORY,
            'other',
            [MessageOpType.BLOCK, [[MessageOpType.ARGSUB], [MessageOpType.TEXT, ' items']]],
          ],
        ],
      ],
      [MessageOpType.TEXT, ' #'],
    ...
    [
      [
        ...
        [
          ...
          [
            [MessageOpType.TEXT, ' '],
            [MessageOpType.BLOCK, [[MessageOpType.TEXT, 'A '], [MessageOpType.ARGSUB], [MessageOpType.TEXT, ' B']]],
            [MessageOpType.TEXT, ' '],
          ],
        ],
      ],
